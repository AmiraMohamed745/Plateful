...
public class ViewAllIngredientsAdapter extends RecyclerView.Adapter<ViewAllIngredientsAdapter.ViewHolder> {

    private final Context context;
    private final List<Ingredient> ingredients = new ArrayList<>();

    public ViewAllIngredientsAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(view -> {
            DestinationNavigator.navigateToAllIngredientsMealsScreen(view, ingredient);
        });
    }
